...
Writes to /opt/ml/processing/train/, /opt/ml/processing/val/, /opt/ml/processing/test/
"""
...
if __name__ == '__main__':
    ...
    input_path = os.path.join(input_dir, 'train_transaction.csv')
    print(f"Reading input from: {input_path}")
    
    # Read only required columns to control memory usage
    df = pd.read_csv(input_path, usecols=RAW_COLS)
    ...
    print("Pre-processing complete. Processed splits saved.")
